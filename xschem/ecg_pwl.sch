...
S {}
E {}
B 2 800 -190 1350 130 {flags=graph,unlocked
...
divx=5
hilight_wave=-1
rawfile=$netlist_dir/ecg_pwl.raw
sim_type=tran
subdivx=3
...
out22
out"}
B 2 240 0 790 320 {flags=graph,unlocked
...
y1=0.898
y2=0.902}
B 2 800 200 1350 520 {flags=graph,unlocked
...
y1=0.8
y2=1}
T {V1 IN1 pwl(file="ecg.txt")} -4090 -200 0 0 0.4 0.4 {}
N -2260 -240 -2180 -240 {
lab=out1}
N -2260 -20 -2180 -20 {
lab=out2}
...
C {devices/iopin.sym} -3230 120 0 0 {name=p4 lab=VDD}
C {devices/iopin.sym} -3230 150 0 0 {name=p5 lab=GND}
C {devices/vsource.sym} -3330 170 0 0 {name=V3 value=1.8 savecurrent=false}
C {devices/gnd.sym} -3230 220 0 0 {name=l4 lab=GND}
C {devices/lab_pin.sym} -3230 180 0 1 {name=p6 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} -3330 230 0 1 {name=p11 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} -3330 110 0 0 {name=p12 sig_type=std_logic lab=VDD}
...
C {devices/simulator_commands_shown.sym} -4090 80 0 0 {name=COMMANDS1
simulator=ngspice
only_toplevel=false 
...
.endc
"}
C {sky130_fd_pr/corner.sym} -4200 60 0 0 {name=CORNER only_toplevel=true corner=tt}
C {devices/lab_pin.sym} -2740 -40 0 0 {name=p2 sig_type=std_logic lab=IN1}
C {devices/lab_pin.sym} -2740 -260 0 0 {name=p9 sig_type=std_logic lab=ref}
C {devices/iopin.sym} -1120 -280 0 0 {name=p10 lab=VDD}
C {devices/iopin.sym} -1060 -280 0 0 {name=p17 lab=GND}
C {devices/launcher.sym} -2870 270 0 0 {name=h5
descr="Annotate OP" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {devices/launcher.sym} -2860 220 0 0 {name=h6
descr="Netlist & sim" 
