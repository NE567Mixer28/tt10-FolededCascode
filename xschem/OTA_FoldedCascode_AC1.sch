...
C {devices/lab_pin.sym} -1050 -280 0 0 {name=p8 sig_type=std_logic lab=IN-}
C {devices/vsource.sym} -1050 -230 0 0 {name=VbiasR2 value="0 ac 1 180
+ sin(0 100u 50 0 0 180)"}
C {devices/lab_pin.sym} -1050 -100 0 1 {name=p9 sig_type=std_logic lab=GND}
C {devices/vsource.sym} -1050 -150 0 0 {name=V1 value=0.9 savecurrent=false}
